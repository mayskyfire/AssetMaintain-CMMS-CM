    ...
    <div class="p-4 space-y-4 pb-24">
      ...
      <UiCard class-name="p-6">
        <div class="flex flex-col items-center mb-6">
          ...
          <h2 class="text-[18px] font-bold text-slate-800 mb-1">สมศักดิ์ ช่างเทคนิค</h2>
          <p class="text-[13px] text-slate-500 mb-3">Technician</p>
          
          <div class="flex gap-2">
            <UiBadge label="ไฟฟ้า" variant="primary" size="small" />
            <UiBadge label="แอร์" variant="success" size="small" />
          </div>
        </div>
        ...
        <div class="space-y-3">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-[13px] text-slate-800">technician@aircm.com</p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-[13px] text-slate-800">089-345-6789</p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-[13px] text-slate-800">ฝ่ายซ่อมบำรุง</p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-[13px] text-slate-800">ระบบไฟฟ้า, เครื่องปรับอากาศ</p>
            </div>
          </div>
        </div>
      </UiCard>
      ...
      <UiCard class-name="p-4">
        ...
        <div class="grid grid-cols-3 gap-4 mb-4">
          <div class="text-center">
            <p class="text-[24px] font-bold text-[#fe9a00]">3</p>
            <p class="text-[11px] text-slate-500">ได้รับมอบหมาย</p>
          </div>
          <div class="text-center">
            <p class="text-[24px] font-bold text-[#00a6ff]">5</p>
            <p class="text-[11px] text-slate-500">กำลังซ่อม</p>
          </div>
          <div class="text-center">
            <p class="text-[24px] font-bold text-[#6dd400]">87</p>
            <p class="text-[11px] text-slate-500">เสร็จสิ้น</p>
          </div>
        </div>

        <div class="h-px bg-slate-200 my-3" />

        <div class="flex items-center justify-between">
          <span class="text-[12px] text-slate-500">เวลาเฉลี่ยต่องาน</span>
          <span class="text-[14px] font-bold text-slate-800">2.5 ชม.</span>
        </div>
      </UiCard>
